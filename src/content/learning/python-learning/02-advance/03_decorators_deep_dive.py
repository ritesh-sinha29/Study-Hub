...
# ==========================================
#
# Q1. Can you decorate an entire class? What does a class decorator do?
# A:  Yes. A class decorator takes a class object as its parameter, modifies
#     its attributes or methods, and returns the modified or wrapped class. It
#     is commonly used to add class mixins, inject properties, or override
...
#     | **Class Decorator** | Instance attributes (self) | Via `__call__` method |
#
