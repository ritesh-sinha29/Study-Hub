...
#
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Variable    | Where Defined         | Scope                 | Shared?         |
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Class Var   | Direct in class body  | Shared across instances| Yes             |
#     | Instance Var| Inside method (self)  | Unique to each object | No              |
#     +-------------+-----------------------+-----------------------+-----------------+
#
...
#
#     +--------------+-----------------------+-----------------------+-----------------+
#     | Decorator    | First Argument        | Can Access Class/Inst?| Use Case        |
#     +--------------+-----------------------+-----------------------+-----------------+
#     | @classmethod | `cls` (class itself)  | Class only (via cls)  | Factory methods |
#     | @staticmethod| None                  | Neither               | Utilities       |
#     +--------------+-----------------------+-----------------------+-----------------+
#
# Q3. How does Python implement encapsulation and private attributes?
# A:  Python does not have strict private access modifiers like Java. Instead,
#     it uses naming conventions: a single underscore (_name) is a warning
#     that it is protected, and a double underscore (__name) triggers 'name
#     mangling', changing it to _ClassName__name to prevent accidental access.