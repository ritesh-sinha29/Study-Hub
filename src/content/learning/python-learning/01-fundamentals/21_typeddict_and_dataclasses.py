...
#
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Feature     | Dataclass             | Dictionary            | Property        |
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Access      | Dot notation (obj.x)  | Key lookup (obj['x']) | OOP structure   |
#     | Type Check  | Strong static checks  | Loose check           | Key constraints |
#     | Overhead    | Lightweight class     | Plain hash map        | Python objects  |
#     +-------------+-----------------------+-----------------------+-----------------+
#
