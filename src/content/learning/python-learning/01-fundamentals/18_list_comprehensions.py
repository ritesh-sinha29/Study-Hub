...
#
#     +--------------+-----------------------+-----------------------+-----------------+
#     | Feature      | List Comprehension    | Generator Expression  | Memory Profile  |
#     +--------------+-----------------------+-----------------------+-----------------+
#     | Syntax       | Square brackets `[]`  | Parentheses `()`      | Generates list  |
#     | Evaluation   | Immediate (eager)     | Lazy (on-demand)      | Uses O(1) RAM   |
#     | Return Type  | List                  | Generator object      | Uses O(n) RAM   |
#     +--------------+-----------------------+-----------------------+-----------------+
#
