...
#
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Feature     | Tuple                 | List                  | Memory/Speed    |
#     +-------------+-----------------------+-----------------------+-----------------+
#     | Mutability  | Immutable (fixed)     | Mutable (modifiable)  | Lists are slower|
#     | Syntax      | Parentheses `()`      | Square brackets `[]`  | Tuples are faster|
#     | Size        | Fixed allocation      | Dynamic over-alloc    | Tuples use less |
#     +-------------+-----------------------+-----------------------+-----------------+
#
